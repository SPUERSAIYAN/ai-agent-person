package cn.agent.ai.trigger.http.admin;

import cn.agent.ai.infrastructure.dao.IAiClientAdvisorConfigDao;
import cn.agent.ai.infrastructure.dao.po.AiClientAdvisorConfig;
